...
public class DispositivoNoAsociadoResource {
    ...
    public ResponseEntity<DispositivoNoAsociadoDTO> createDispositivoNoAsociado(@RequestBody DispositivoNoAsociadoDTO dispositivoNoAsociadoDTO) throws URISyntaxException {
    ...
    public ResponseEntity<DispositivoNoAsociadoDTO> updateDispositivoNoAsociado(@RequestBody DispositivoNoAsociadoDTO dispositivoNoAsociadoDTO) throws URISyntaxException {
