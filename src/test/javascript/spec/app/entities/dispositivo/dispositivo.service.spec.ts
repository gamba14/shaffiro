...
import { IDispositivo, Dispositivo, TipoDispositivo } from 'app/shared/model/dispositivo.model';
...
describe('Service Tests', () => {
    describe('Dispositivo Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Dispositivo(0, 'AAAAAAA', TipoDispositivo.SENSOR, false, 'AAAAAAA', 0);
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a Dispositivo', async () => {
            ...
            it('should return a list of Dispositivo', async () => {
                const returnedFromService = Object.assign(
                    {
                        nombre: 'BBBBBB',
                        tipo: 'BBBBBB',
