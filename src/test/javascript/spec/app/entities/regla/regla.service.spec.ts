...
describe('Service Tests', () => {
    describe('Regla Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Regla(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA');
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should return a list of Regla', async () => {
                const returnedFromService = Object.assign(
                    {
                        nombre: 'BBBBBB',
                        logica: 'BBBBBB',
